...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            export(libs.kdeeplink.navigation.compose.external)
...
android {
    namespace = "com.lucasferreiramachado.kapp.android"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.lucasferreiramachado.kapp.android"
...
compose.desktop {
    application {
        mainClass = "com.lucasferreiramachado.kapp.desktop.MainKt"
